...
const validateUser = user => {
	const schema = z.object({
		...
		email: z.string().trim().nonempty('Email is a required field.').email('Email is not valid').min(5, 'Email field must be at least 5 characters').max(255, 'Email must contain at most 255 characters'),
